		...
		<footer className="mt-140 bg-red py-70 max-lg:py-40 max-lg:mt-80 max-lg:overflow-hidden">
			<div className="container flex flex-col gap-40">
				<Row gutter={isMobile ? [40, 40] : [20, 20]}>
					...
					>
						<div className="flex flex-col items-end gap-36 font-display max-lg:gap-12">
							...
							<div className="flex gap-40 items-end justify-end">
								...
								/>
								<Button
									onClick={() => window.open("https://ab-capital.kz/", "blank")}
								>
									САЙТ ЗАСТРОЙЩИКА
								</Button>
							</div>
					...
					>
						<div className="flex flex-col gap-12 font-display">
							<span className="text-sm text-yellow-100/50 -tracking-[0.02em] leading-normal">
								Меню
							</span>
							<div className="flex flex-col">
				...
				<div className="flex flex-col gap-24">
					<p className="text-xs text-yellow-100/50 -tracking-[0.02em] leading-normal">
						Бұл жарнама әлеуетті тұтынушылардың сұранысын зерттеу мақсатында
						орналастырылған. Осы жарнама ҚР АК 395-бабына сәйкес жария оферта
						болып табылмайды.
						<br />
						Тұрғын үй құрылысына үлестік қатысу туралы шарттар жергілікті
						атқарушы орган үлескерлердің ақшасын тартуға рұқсат бергеннен кейін
						ғана жасалатын болады.
					</p>
					<p className="text-xs text-yellow-100/50 -tracking-[0.02em] leading-normal">
						Данная реклама размещена с целью изучения спроса потенциальных
						потребителей. Настоящая реклама, в соответствии со ст. 395 ГК РК, не
						является публичной офертой. <br /> Договоры о долевом участии в
						жилищном строительстве будут заключаться только после выдачи
				...
				<div className="grid grid-cols-2 gap-50 max-lg:gap-24">
					<p className="text-xs text-yellow-100/50 -tracking-[0.02em] leading-[1.2] col-span-1 max-lg:col-span-2">
						Жобаның архитектурасы, абаттандырудың, қасбеттердің, интерьердің,
						қолданылатын материалдардың бейнелері, олардың нөмірленуі, кешеннің
						инфрақұрылымы шартты болып табылады және жобалау, салу және
						пайдалану барысында өзгертілуі мүмкін.
					</p>
					<p className="text-xs text-yellow-100/50 -tracking-[0.02em] leading-[1.2] col-span-1 max-lg:col-span-2">
